...
import com.krhonos.etablissement.dao.ServiceDao;
...
public class ServiceController {
  ...
  public Service postService(@RequestBody Service service) {
    return repository.save(new Service(service.getNom(), service.getEtabId()));
  }

  @PutMapping("/services/{id}")
  public ResponseEntity<Service> updateService(
          @PathVariable("id") long id, @RequestBody Service service) {
