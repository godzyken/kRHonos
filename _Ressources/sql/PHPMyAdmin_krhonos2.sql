...
--
-- H�te : 127.0.0.1
-- G�n�r� le :  Dim 21 oct. 2018 � 16:51
...
--
-- D�chargement des donn�es de la table `civilite`
--
...
--
-- D�chargement des donn�es de la table `coefficient`
--
...
--
-- D�chargement des donn�es de la table `convention`
--

INSERT INTO `convention` (`convention_id`, `convention_libelle`, `convention_valeur_point`) VALUES
(1, 'Convention collective nationale de travail des etablissements et services pour personnes inadapt�es et handicap�es du 15 mars 1966', 3.77);
...
--
-- D�chargement des donn�es de la table `emploi`
--

INSERT INTO `emploi` (`emploi_id`, `emploi_libelle`, `emploi_cadre`, `convention_id`, `grille_id`) VALUES
(1, 'Agent de service int�rieur', 0, 1, 1),
(2, 'Agent technique sup�rieur', 0, 1, 8),
(3, 'Aide m�dico-psychologique', 0, 1, 6),
(4, 'Aide-soignant', 0, 1, 6),
(5, 'Auxiliaire de vie sociale', 0, 1, 6),
(6, 'Chef de service', 1, 1, 16),
(7, 'Chef de service �ducatif', 1, 1, 16),
(8, 'Comptable 1ere classe', 0, 1, 10),
(9, 'Directeur', 1, 1, 23),
(10, 'Directeur g�n�ral', 1, 1, 26),
(11, 'Educateur sp�cialis�', 0, 1, 10),
(12, 'Educateur sportif', 0, 1, 10),
(13, 'Ergoth�rapeute', 0, 1, 10),
(14, 'Gestionnaire de paie', 0, 1, 10),
(15, 'Infirmier', 0, 1, 10),
(16, 'Kin�sith�rapeute', 0, 1, 10),
(17, 'Moniteur-�ducateur', 0, 1, 8),
(18, 'Psychologue', 1, 1, 14),
(19, 'Directeur administratifs et financiers', 1, 1, 25),
(20, 'Directeur des ressources humaines', 1, 1, 25),
(21, 'Secr�taire d\'accueil', 0, 1, 8),
(22, 'Secr�taire de direction', 0, 1, 10),
...
--
-- D�chargement des donn�es de la table `emploi__taux_charges`
--
...
--
-- D�chargement des donn�es de la table `etablissement`
--
...
--
-- D�chargement des donn�es de la table `grille`
--
...
--
-- D�chargement des donn�es de la table `grille__coefficient`
--
...
--
-- D�chargement des donn�es de la table `nature_contrat`
--
...
(25, 'Serre', 'Gillet', 'Am�lie', 2, 25, 25),
(26, 'Tanguy', '', 'Lorenzo', 1, 26, 26),
(27, 'Leon', 'Louis', 'Ambre', 2, 27, 27),
(28, 'Toussaint', '', 'In�s', 2, 28, 28),
(29, 'Leleu', '', 'Bruno', 1, 29, 29),
(30, 'Flament', 'Jacquemin', 'L�ane', 2, 30, 30),
...
--
-- D�chargement des donn�es de la table `salarie`
--
...
(8, 8, '2870230189229', 18, '1987-02-02', 'Robin', '', 'Ana�s', 1, 2, 8, 8),
...
(18, 18, '2871075110074', 1, '1987-10-13', 'Caron', '', 'Fran�oise', 1, 2, 18, 18),
...
(25, 25, '2710734032014', 73, '1971-07-02', 'Serre', 'Gillet', 'Am�lie', 2, 2, 25, 25),
(26, 26, '1820878172034', 12, '1982-08-09', 'Tanguy', '', 'Lorenzo', 1, 1, 26, 26),
(27, 27, '2880734301081', 27, '1988-07-23', 'Leon', 'Louis', 'Ambre', 2, 2, 27, 27),
(28, 28, '2680615162150', 76, '1968-06-20', 'Toussaint', '', 'In�s', 1, 2, 28, 28),
(29, 29, '1770509160048', 90, '1977-05-28', 'Leleu', '', 'Bruno', 1, 1, 29, 29),
(30, 30, '2790715014049', 20, '1979-07-10', 'Flament', 'Jacquemin', 'L�ane', 2, 2, 30, 30),
...
(42, 42, '2850934172468', 3, '1985-09-29', 'Pons', '', 'El�na', 1, 2, 42, 42),
...
(46, 46, '2690982121063', 68, '1969-09-17', 'Lejeune', 'Leblanc', 'Elo�se', 2, 2, 46, 46),
...
--
-- D�chargement des donn�es de la table `situation_familiale`
--
...
--
-- D�chargement des donn�es de la table `taux_charges`
--
...
--
-- D�chargement des donn�es de la table `utilisateur__role`
--
